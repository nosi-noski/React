...
let dialogsElements = dialogsData.map( (d) => <DialogItem name={d.name} dialogId={d.id} key={d.id}/>);
let messagesElements = messagesData.map( (m) => <MessageItem message={m.message} key={m.id}/>);
